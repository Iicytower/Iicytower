...
- :-1: Not love in JS: `'` and `"` one way to declare strings is enough, but it can't be deleted :cry:. 
- :rage: Hate in JS: This language is too liberal to developer mistakes. If you want, you can use `;` if not you have no obligation, and more. But again backward compatibility say: "HAHAHA!"
